      ...
      <div class="col-12 col-md-4">
        <div class="card bg-info text-white h-100 shadow-sm border-0 hover-card">
          <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
            ...
            <p class="card-text text-uppercase small tracking-wider mb-0 mt-1 text-dark">Alumnos en Nivel 4</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
          ...
          <div class="modal-body text-center p-4">
            ...
            <p class="fs-5">¿Estás seguro de que deseas dar de baja a este alumno? Toda su información y progreso se perderá.</p>
          </div>
          <div class="modal-footer justify-content-center">
            <button type="button" class="btn btn-secondary fw-bold px-4" @click="mostrarModalEliminar = false">Cancelar</button>
            <button type="button" class="btn btn-danger fw-bold px-4" @click="ejecutarEliminacion">Sí, dar de baja</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
          ...
          <div class="modal-footer justify-content-center border-0">
            <button type="button" class="btn btn-primary fw-bold px-5 rounded-pill" @click="alumnoSeleccionado = null">¡Entendido!</button>
          </div>
        </div>
      </div>
    </div>
